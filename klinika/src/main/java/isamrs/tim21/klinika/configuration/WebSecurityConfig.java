...
import isamrs.tim21.klinika.security.auth.RestAuthenticationEntryPoint;
import isamrs.tim21.klinika.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
				"/**/*.css", "/**/*.js", "/api/zahtevi_za_registraciju/registruj/{id}", "/api/cenovnik/{idKlinike}/dummy", 
				"/api/cenovnik/{idKlinike}/dummy");
	}
