...
insert into korisnik (type, klinika_id, email, sifra, ime, prezime, broj_telefona, drzava, grad, jbo, id, enabled) values ('LE', 3, 'lekar3@gmail.com', '$2a$10$cVG9lUTjhiB2j8HqrSk6B.PifdUlXCPZ6IDOIq.LrltVTXWSuVRqS', 'Ognjen', 'Peric', '1', 'Serbia', 'Novi Sad', 8, 8, 0x01);
...
insert into tip_pregleda (id, naziv, opis, klinika_id, cenovnik_id) values (1, 'Kardiološki pregled', 'Opšti pregled srca i krvnih sudova', 1, 1);
insert into tip_pregleda (id, naziv, opis, klinika_id, cenovnik_id) values (2, 'Kardiološko testiranje', 'Opšte testiranje srca i krvnih sudova', 1, 1);
insert into tip_pregleda (id, naziv, opis, klinika_id, cenovnik_id) values (3, 'Gastroenterološki pregled', 'Opšti pregled sistema za varenje', 2, 2);
insert into tip_pregleda (id, naziv, opis, klinika_id, cenovnik_id) values (4, 'Pulmološki pregled', 'Opšti pregled pluća', 3, 3);
insert into tip_pregleda (id, naziv, opis, klinika_id, cenovnik_id) values (5, 'Pulmološko testiranje', 'Opšte testiranje pluća', 3, 3);
...
insert into pregled (klinika_id, lekar_id, sala_id, tip_pregleda_id, pocetak_pregleda, kraj_pregleda, cena, popust, konacna_cena) values (1, 3, 2, 2, STR_TO_DATE('28/05/2020 12:00:00','%d/%m/%Y %H:%i:%s'), STR_TO_DATE('28/05/2020 13:00:00','%d/%m/%Y %H:%i:%s'), 1000, 0, 1000);
insert into pregled (klinika_id, lekar_id, sala_id, tip_pregleda_id, pocetak_pregleda, kraj_pregleda, cena, popust, konacna_cena) values (1, 3, 2, 2, STR_TO_DATE('01/06/2020 12:00:00','%d/%m/%Y %H:%i:%s'), STR_TO_DATE('01/06/2020 13:00:00','%d/%m/%Y %H:%i:%s'), 1000, 0, 1000);
...
insert into pregled (klinika_id, lekar_id, sala_id, tip_pregleda_id, pocetak_pregleda, kraj_pregleda, cena, popust, konacna_cena) values (3, 8, 5, 5, STR_TO_DATE('28/05/2020 12:00:00','%d/%m/%Y %H:%i:%s'), STR_TO_DATE('28/05/2020 13:00:00','%d/%m/%Y %H:%i:%s'), 1000, 0, 1000);
insert into pregled (klinika_id, lekar_id, sala_id, tip_pregleda_id, pocetak_pregleda, kraj_pregleda, cena, popust, konacna_cena) values (3, 8, 5, 5, STR_TO_DATE('01/06/2020 12:00:00','%d/%m/%Y %H:%i:%s'), STR_TO_DATE('01/06/2020 13:00:00','%d/%m/%Y %H:%i:%s'), 1000, 0, 1000);